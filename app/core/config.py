...
class Settings(BaseSettings):
    ...
    cors_origins: str = "http://localhost:5173,http://127.0.0.1:5173,https://frontendbb.onrender.com,https://backend-kidzventure.onrender.com,capacitor://localhost,http://localhost"
